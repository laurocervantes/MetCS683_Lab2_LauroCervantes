...
import com.example.testing.databinding.CardViewProjectListBinding
...
class MyProjListRecyclerViewAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(CardViewProjectListBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
 ...
 //           val action = ProjListRecycleViewFragmentDirection. ----> THIS DOESN'T WORK
    ...
    inner class ViewHolder(binding: CardViewProjectListBinding)
